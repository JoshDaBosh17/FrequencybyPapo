        ...
        <GlassCard strong className="overflow-hidden rounded-[28px] p-4 sm:p-5">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-3 self-start md:self-auto">
              ...
              <button
                className="inline-flex min-h-11 items-center gap-2 rounded-full border border-[var(--line)] bg-white/75 px-4 text-sm font-medium text-[var(--text-soft)] transition hover:bg-white"
